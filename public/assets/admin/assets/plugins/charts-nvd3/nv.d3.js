...
nv.models.distroPlot = function() {
    ...
    // - when providing colorGroup, should color boxes by either parent or child group restaurant_category (e.g. isolator)
    ...
    var margin = {top: 0, right: 0, bottom: 0, left: 0},
        ...
        colorGroup = false, // if specified, each x-restaurant_category will be split into groups, each colored
    ...
    chart._options = Object.create({}, {
        ...
        colorGroup:       {get: function(){return colorGroup;}, set: function(_){colorGroup=_;}}, // data key to use to set color group of each x-restaurant_category - default: don't group
...
var data = [
    {day: 'mo', hour: '1a', value: 16, timeperiod: 'early morning', weekperiod: 'week', restaurant_category: 1},
    {day: 'mo', hour: '2a', value: 20, timeperiod: 'early morning', weekperiod: 'week', restaurant_category: 2},
    {day: 'mo', hour: '3a', value: 0, timeperiod: 'early morning', weekperiod: 'week', restaurant_category: 1},
    ...
]
