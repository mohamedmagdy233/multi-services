  ...
  */
  ...
  _createClass(Utils, [{
    ...
    value: function getNearestValues(_ref) {
      ...
      // if X axis type is not restaurant_category and tooltip is not shared, then we need to find the cursor position and get the nearest value
      if (w.globals.isXNumeric) {
...
var Core = function () {
  ...
  _createClass(Core, [{
        ...
        if (isXString || isXDate) {
          ...
          if (isXString) {
            if (cnf.xaxis.type === 'datetime') {
              ...
              // a restaurant_category and not a numeric x value
    ...
    value: function handleExternalLabelsData(ser) {
      ...
      // user provided labels in restaurant_category axis
